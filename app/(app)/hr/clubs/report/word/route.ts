import { getClubReportData } from "@/app/(app)/hr/clubs/actions";
import { buildClubReportDocx, clubReportDocxFilename } from "@/lib/clubReportDocx";
...
export async function GET(request: Request) {
  ...
  const bytes = await buildClubReportDocx(year, month, clubs);
  const filename = clubReportDocxFilename(year, month);
