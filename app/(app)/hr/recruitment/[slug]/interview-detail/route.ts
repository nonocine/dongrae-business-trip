...
import { buildInterviewDetailWorkbook } from "@/lib/recruitmentDocBuilders";
...
export async function GET(
  ...
  const buffer = await buildInterviewDetailWorkbook(data);
  const filename = `면접세부평가_${data.posting.slug}.xlsx`;
