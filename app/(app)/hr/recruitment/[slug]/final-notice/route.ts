...
import { buildFinalNoticeDoc } from "@/lib/recruitmentDocBuilders";
...
export async function GET(
  ...
  const buffer = await buildFinalNoticeDoc(data);
  return docxResponse(buffer, `최종합격자공고_${data.posting.slug}.docx`);
}
