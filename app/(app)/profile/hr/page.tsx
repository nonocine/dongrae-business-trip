...
import MyEmployeeProfileForm from "@/app/(app)/profile/hr/MyEmployeeProfileForm";
import MyTrainingsSection from "@/app/(app)/profile/hr/MyTrainingsSection";
...
} from "@/app/(app)/hr/certificates/actions";
