...
export default async function Home({
  ...
  //   ★ 헤더와 <main> 껍데기는 (app)/layout.tsx 가 그립니다. 위쪽 비로그인
  //     분기는 그 레이아웃이 껍데기를 씌우지 않으므로 자기 <main> 을 직접
  //     그리고, 여기(로그인 후)는 폭만 잡는 컨테이너면 됩니다.
  return (
    <div className="mx-auto w-full max-w-3xl space-y-4 px-4 py-5 sm:py-6">
      {recruitmentCount > 0 && <RecruitmentBanner count={recruitmentCount} />}
